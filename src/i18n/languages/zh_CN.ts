...
export const zh_CN: Translation = {
	...
	// 阅读计划筛选和状态文本（原番组计划）
	[Key.bangumiTitle]: "我的阅读计划",
	[Key.bangumiSubtitle]: "来自微信读书的公开书架与阅读统计",
	...
	// 影视（原追番）
	[Key.anime]: "影视",
	[Key.animeSubtitle]: "我的影视列表，数据来自 Bilibili 和 TMDB",
	[Key.animeTotal]: "总数",
	[Key.animeAverageRating]: "平均评分",
	[Key.animeSearch]: "搜索影视...",
